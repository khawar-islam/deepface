...
def preprocess_face(img, target_size=(224, 224), grayscale=False, enforce_detection=True, detector_backend='mtcnn'):
    ...
    img = detect_face(img=img, detector_backend=detector_backend, grayscale=grayscale,
    ...
    if img.shape[0] > 0 and img.shape[1] > 0:
        ...
        if enforce_detection == False:  # True (By Default)
            # print(img)
            raise ValueError("Detected face shape is ", img.shape, img,
